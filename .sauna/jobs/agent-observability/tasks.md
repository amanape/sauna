...
- [x] Enable streaming in discover mode: pass `streaming: true` and `onChunk: reporter.onChunk` to `runConversation()` in `main()` discover case (`src/cli.ts:412-425`) — discover-streaming.md
